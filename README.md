...
Engineered around the **Multi-Repository Satellite Architecture**, all 23 subsystems operate as completely independent repositories with independent release lifecycles and CI/CD pipelines, unified under this workspace orchestrator.
...
| **`ZeroGraphics`** | [`kzxl/ZeroGraphics`](https://github.com/kzxl/ZeroGraphics) | Render Hardware Interface (RHI - Null & D3D11), COM VTable D3D11/D2D, 144Hz waveforms, computational photography (Mertens HDR, focus stacking), industrial CV & Barcode HRI suite. |
...
| **`ZeroGraphics`** | `v1.4.0` | Active | Render Hardware Interface (RHI - Null & D3D11), COM VTable D3D11/D2D, 144Hz waveforms, computational photography, industrial CV & Barcode HRI suite. |
